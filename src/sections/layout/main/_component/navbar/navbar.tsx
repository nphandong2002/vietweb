  ...
  return (
    <nav className="fixed z-[90] bottom-0 bg-[var(--bg-navbar)]">
      <div className="border-r-gray-500 border-dashed border border-t-gray-500">
        <div className="md:h-screen w-screen h-[var(--height-nav)] overflow-overlay md:w-[var(--min-width-nav)] lg:w-[var(--width-nav)] flex flex-row md:flex-col justify-center">
          <NavbarList />
          <Button className="p-0">{t('login')}</Button>
