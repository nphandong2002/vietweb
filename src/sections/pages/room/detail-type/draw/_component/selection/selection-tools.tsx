...
export const SelectionTools = memo(({ camera, setLastUsedColor }: SelectionToolsProps) => {
  ...
  return (
    <div
      className="absolute p-3 rounded-xl bg-[var(--bg-color)] shadow-sm border flex select-none"
      style={{
